...
Перед подтверждением в форме требуется единственное видимое резюме с названием,
совпадающим с настроенным (регистр и лишние пробелы не учитываются). Несовпадение,
дубликаты или отсутствие названия переводят вакансию в `needs_manual` без нажатия submit.
